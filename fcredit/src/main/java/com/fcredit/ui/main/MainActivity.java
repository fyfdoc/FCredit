...
import com.fcredit.widget.bottombar.CustomTabEntity;
...
public class MainActivity extends BaseActivity implements IBaseMvpActivity<MainPresenter>, MainContract.View {
    ...
    public void initViewAndEvent() {
        StatusBarUtil.setColorForDrawerLayout(this, getResources().getColor(R.color.theme_color_black), mFrameLayout);
